    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    <button class="btn btn-danger btn-sm" @click="send">Simpan</button>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        send() {
            ...
            axios.post(`/cadidate/dpm/${this.form.nomor_urut}?token=${this.user.token}`, fd)
            .then(r => {
                this.$router.push({name: "Cadidate Dpm", params: []})
            })
            .catch(e => {
                let r = e.response;
                if (r) {
    ...
    mounted() {
        ...
        axios.get(`/cadidate/dpm/${this.nomor_urut}`)
        .then(r => {
            this.form = r.data.body;
        })
    }
}
</script>